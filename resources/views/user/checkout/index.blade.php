            ...
            <table class="table mb-0">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" name="pembayaran" id="pembayaranSaldo"
                        value="saldo" checked>
                ...
                <tr>
                  <td colspan="2">
                    <div class="custom-control custom-radio">
                      <input class="custom-control-input" type="radio" name="pembayaran" id="pembayaranTf"
                        value="transfer">
  ...
  <script>
    $(function() {
      ...
      $('.select-jenis').change(function() {
        ...
        $(`.text-harga[data-id=${id}]`).text(Number(totalTokoOngkir).toLocaleString('id-ID', {
          style: 'currency',
          currency: 'IDR',
          maximumFractionDigits: 0
        }))
      ...
      $(document).on('click', '.pay-button', function() {
        ...
        var metode = $('input[name="pembayaran"]:checked').val();
        $('input[name="metode"]').val(metode);

        if (metode == 'transfer') {
          fetch('/checkout/get-payment', {
              method: 'POST',
              headers: {
