<div class="modal-header">
  <h5 class="modal-title">Ubah Zat Aktif</h5>
...
<form id="formEditKandungan" action="{{ route('admin.kandungan.update', $kandungan->id) }}" class="modal-body"
  ...
  <div>
    ...
    <input type="text" name="nama" class="form-control" placeholder="Nama zat aktif" value="{{ $kandungan->nama }}" required>
  </div>
</form>
...
<div class="modal-footer">
  ...
  <button form="formEditKandungan" class="btn btn-primary btn-block">Ubah</button>
</div>
